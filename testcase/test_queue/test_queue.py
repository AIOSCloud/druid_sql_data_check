...
online_url, online_header, online_json = Queue.package_queue(online_host, online_db, start, end)
offline_url, offline_header, offline_json = Queue.package_queue(offline_host, offline_db, start, end)
